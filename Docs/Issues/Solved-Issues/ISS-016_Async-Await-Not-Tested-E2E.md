...
- 2026-07-10 (PROP-045): Scénář 7 (AsyncPipeline) přidán do `EndToEndScenariosTests`.
- 2026-07-12: Scénář 7 rozšířen o `AssertGeneratedCodeMatches` — ověřuje přesný výstup async metody s `await` a `IsAsync = true`.
