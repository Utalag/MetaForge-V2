...
- 2026-07-12: `BusinessDocumentDiffer.Diff()` nyní detekuje `Modified` změny: (1) změna názvu entity, (2) změna vlastností atributů (Name, Type, IsRequired, MaxLength, DefaultValue). Implementováno pomocí `DetectAttributeModifications()`. 
